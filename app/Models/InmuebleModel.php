...
class InmuebleModel extends Model
{
    ...
    protected $allowedFields=['nombre', 'id_provincias', 'id_localidades', 'tipo_via', 'direccion', 'cp', 'numero', 'piso', 'letra', 'escalera', 'precio', 'habitaciones', 'metros_cuadrados', 'exterior', 'aseos', 'terraza', 'balcon', 'orientacion', 'ascensor', 'descripcion', 'foto'];
